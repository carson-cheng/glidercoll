...
static never_inline int do_search (const char *spec)
{
	...
	Random_set_seed (&st.random, time(NULL));
	...
	while (TRUE)
	{
        ...
        gl_5.dir = Random_get (&st.random) % 4;
        gl_5.lane = (Random_get (&st.random) % lane_cnt) - (lane_cnt / 2);
        Objects_set_glider_progression (&gl_5, -1024 + (Random_get (&st.random) % prog_cnt));
        
        gl_6.dir = Random_get (&st.random) % 4;
        gl_6.lane = (Random_get (&st.random) % lane_cnt) - (lane_cnt / 2);
        Objects_set_glider_progression (&gl_6, -1024 + (Random_get (&st.random) % prog_cnt));
		
		seeds_cnt++;
		
		if (will_interfere (&gl_1, &gl_2) || will_interfere (&gl_1, &gl_3) || will_interfere (&gl_1, &gl_4) || will_interfere (&gl_1, &gl_5) ||  will_interfere (&gl_1, &gl_6) || will_interfere (&gl_2, &gl_3) || will_interfere (&gl_2, &gl_4) || will_interfere (&gl_2, &gl_5) || will_interfere (&gl_2, &gl_6) || will_interfere (&gl_3, &gl_4) || will_interfere (&gl_3, &gl_5) || will_interfere (&gl_3, &gl_6) || will_interfere (&gl_4, &gl_5) || will_interfere (&gl_4, &gl_6) || will_interfere (&gl_5, &gl_6))
		{
			interferes_cnt++;
			continue;
		}
        ...
        update_min_distance (&gl_1, &gl_5, &min_dist);
        update_min_distance (&gl_1, &gl_6, &min_dist);
		update_min_distance (&gl_2, &gl_3, &min_dist);
		update_min_distance (&gl_2, &gl_4, &min_dist);
        update_min_distance (&gl_2, &gl_5, &min_dist);
        update_min_distance (&gl_2, &gl_6, &min_dist);
		update_min_distance (&gl_3, &gl_4, &min_dist);
        update_min_distance (&gl_3, &gl_5, &min_dist);
        update_min_distance (&gl_3, &gl_6, &min_dist);
        update_min_distance (&gl_4, &gl_5, &min_dist);
        update_min_distance (&gl_4, &gl_6, &min_dist);
        update_min_distance (&gl_5, &gl_6, &min_dist);
        ...
        GoLGrid_or_glider (st.seed, &gl_5, TRUE);
        GoLGrid_or_glider (st.seed, &gl_6, TRUE);
